#este test alumno esta con mapping integrado.
import unittest
import os
...
class AppTestCase(unittest.TestCase):
    ...
    def test_serializacion_alumno(self):
        ...
        # 3.  Verificamos que el mapping coincida
    ...
    def __nuevo_alumno(self, dni="12345678", legajo=1234):
        ...
        # Si 'tipo_documento' es una relación, asegúramos de manejar la sesión correctamente si ya existe "DNI".
